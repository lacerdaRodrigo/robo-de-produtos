...
| [`pichau.yml`](workflows/pichau.yml) | Coleta e publica o catálogo PC Gamer da Pichau com SeleniumBase UC/headless2, isolado dos demais robôs | 09h/15h/21h + manual técnico | `DATABASE_URL` |
