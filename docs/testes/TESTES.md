...
| CT-393 | Inicialização transitória do DevTools | Resposta JSON parcial ou ausência momentânea de uma aba DevTools durante o boot do Chrome aguarda a estabilização dentro de limite finito antes de recriar a sessão Appium | `teste_pichau.py` |
