...
| V15-014 | Gate offline recuperável | Validação inicial do perfil não fica presa sem rede: expira em até 10 s, mostra falha legível e permite tentar novamente | `app/test/app/autenticacao/portao_test.dart`, validação física no Samsung |
