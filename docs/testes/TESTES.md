...
| CT-372 | Retry, bloqueio e diagnóstico seguro | Respostas transitórias e falhas de navegador podem repetir dentro do limite de três tentativas e cooldown de 2–5 s; bloqueio persistente encerra a coleta e o log registra apenas título, URL final, tamanho e marcadores, sem HTML/cookies/headers | `teste_pichau.py` |
