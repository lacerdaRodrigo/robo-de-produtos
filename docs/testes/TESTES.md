...
| CT-293A | Escopo contextual de Produtos | O app envia somente o identificador de escopo aprovado; a API o resolve em categorias externas exatas, mantém paginação, rejeita escopo desconhecido e não combina escopo com categoria externa ou `Sem categoria` | Vitest da rota e repositório; widget do seletor contextual |
