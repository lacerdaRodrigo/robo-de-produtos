...
- [x] Fazer a primeira coleta real no Samsung: as execuções 6 e 8 provaram o caminho histórico de 33 páginas; a execução 22 aprovou o caminho rápido com 12 páginas, `1169/1169` itens únicos, zero duplicados e 1.169 medições em aproximadamente 3m55s. A tentativa concorrente 7 falhou com código `acesso` sem substituir snapshot.
...
- [ ] Fazer mais duas execuções consecutivas do caminho rápido, validar o receiver do Termux:Boot após reinicialização e conferir API/Flutter.
