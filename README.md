...
> **Status: V1.0 funcionando.** Rodou fim a fim contra a página real: 247 parceiros lidos, 9 promoções encontradas. 71 testes verdes, 94% de cobertura. Falta configurar os segredos no GitHub para a primeira execução agendada.
