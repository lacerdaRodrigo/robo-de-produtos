...
from robo_inter import __version__
from robo_inter.adaptadores_inter import FonteInterHttp, RepositorioInterPostgres
from robo_inter.extrator_inter import (
    ConflitoIdentidadeInter,
    RespostaInterInvalida,
    extrair_lojas,
)
from robo_inter.modelos_inter import RetratoInter
from robo_inter.portas_inter import (
...
from robo_inter.retrato_inter import montar_retrato_inter

_log = logging.getLogger("robo_inter.inter")
