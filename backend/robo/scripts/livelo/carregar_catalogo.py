...
RAIZ_REPOSITORIO = Path(__file__).resolve().parents[4]
RAIZ_ROBO = Path(__file__).resolve().parents[2]
ESQUEMA = RAIZ_REPOSITORIO / "migracoes" / "001_esquema.sql"
CATALOGO = RAIZ_ROBO / "config" / "livelo" / "lojas_favoritas.toml"
