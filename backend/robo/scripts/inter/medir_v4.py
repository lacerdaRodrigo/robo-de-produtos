...
from robo_inter.extrator_produtos_inter import extrair_lojas_diretas, normalizar_busca_produtos
from robo_inter.modelos_produtos_inter import (
    LojaDiretaInter,
    ProdutoDiretoInter,
    ResumoColetaProdutosInter,
)
from robo_inter.principal_produtos_inter import BUSCAS_SUPLEMENTARES, coletar_produtos_de_loja
