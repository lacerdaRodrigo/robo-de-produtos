...
A V4 está **somente especificada** no [`docs/PRD-V4.md`](docs/PRD-V4.md), desde 2026-08-16. Ela trata a área Compre direto no Inter como terceira integração: seleciona qualquer quantidade de lojas, pagina todo o catálogo exposto de cada uma três vezes ao dia, busca somente no banco e guarda 30 dias de histórico. Nenhum módulo, migração, workflow ou rota da V4 existe ainda. Antes do código, V4.1 precisa medir uma loja completa e fechar schema, staging, volume e custo.
